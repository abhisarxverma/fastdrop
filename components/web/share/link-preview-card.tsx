...
export function LinkPreviewCard({ response, isValidating }: { response: LinkMetadataResponse | null, isValidating: boolean }) {

  if (isValidating) return (
    <Card className="mt-4 border bg-secondary animate-pulse h-full">
      <CardContent className="flex flex-col gap-2 h-full">
        <div className="h-25 w-full bg-muted rounded mb-3" />
